...
const { getGSTR1Data, getGSTR2Data, getGSTR3BData, prepareGSTR1JSON, getFilings, markFiled, importGSTR2B } = require('../controllers/gstFilingController');
...
router.post('/import-2b', authorize('reports:manage'), importGSTR2B);
