...
const updateExpense = async (req, res) => {
  try {
    ...
    const totalAmount = amount + tax;
    const updated = await Expense.findByIdAndUpdate(req.params.id, { date, expenseNumber, category, description, paymentMethod, items, roundOff, amount, tax, totalAmount }, { new: true });
...
const deleteExpense = async (req, res) => {
  try {
    ...
    await Transaction.deleteMany({ referenceModel: 'Expense', referenceId: expense._id });
