        ...
        {showNoteInput && (
          <div className="space-y-3">
            ...
            <div className="flex justify-end gap-2">
              <button onClick={() => { setShowNoteInput(false); ledgerNoteAPI.get('customer', id).then(r => setNote(r.data.note || '')).catch(() => null); }} className="px-3 py-1.5 text-xs font-medium text-slate-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">Cancel</button>
