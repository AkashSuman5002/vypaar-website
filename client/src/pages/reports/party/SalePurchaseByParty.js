...
const columns = [
  ...
  { key: 'partyName', label: 'Party Name', width: 'w-[250px]' },
  { key: 'saleAmount', label: 'Sale Amount', width: 'w-[160px]', align: 'right' },
  { key: 'purchaseAmount', label: 'Purchase Amount', width: 'w-[160px]', align: 'right' },
];
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const res = await reportAPI.getSalePurchaseByParty(params);
  ...
  return (
    <div className="p-4 bg-white dark:bg-[#0F172A] min-h-full">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-base font-semibold text-gray-900 dark:text-[#F8FAFC]">Sale Purchase By Party</h2>
        ...
        <table className="w-full text-xs">
              ...
              <tr>
                <td colSpan={columns.length} className="px-3 py-12 text-center text-sm text-gray-500 dark:text-[#64748B]">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <span className="text-sm text-gray-500 dark:text-[#64748B]">No data is available for Sale Purchase by Party</span>
                  </div>
                </td>
              </tr>
            ) : (
          ...
          <tfoot>
            <tr className="bg-gray-50 dark:bg-[#111827] border-t border-gray-200 dark:border-[#334155]">
              <td colSpan={2} className="px-3 py-2.5 text-xs font-semibold text-gray-700 dark:text-[#E2E8F0] text-right">Total</td>
