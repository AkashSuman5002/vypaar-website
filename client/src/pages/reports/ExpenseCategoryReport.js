...
const ExpenseCategoryReport = () => {
  ...
  const handleDownload = () => {
    ...
    const a = document.createElement('a'); a.href = url; a.download = 'expense-category-report.csv'; a.click();
  ...
  return (
    <>
      <ReportHeader title="Expense Category Report" description="View expenses grouped by category." onDownload={handleDownload} onPrint={handlePrint} />
