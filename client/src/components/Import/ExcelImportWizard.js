...
const appFields = {
  ...
  Items: ['name', 'category', 'price', 'stock', 'gstRate', 'unit', 'hsn', 'costPrice', 'barcode', 'minStock', 'storageLocation', 'description'],
  Sales: ['invoiceNumber', 'customerName', 'date', 'itemName', 'quantity', 'rate', 'totalAmount', 'paidAmount', 'paymentMethod', 'taxableAmount', 'cgstTotal', 'sgstTotal'],
  Purchases: ['invoiceNumber', 'supplierName', 'date', 'itemName', 'quantity', 'rate', 'totalAmount', 'paidAmount', 'paymentMethod'],
...
const FIELD_ALIASES = {
  ...
  Stock: { productName: ['itemname', 'name', 'productname', 'item', 'product'], quantity: ['quantity', 'qty', 'stock', 'units', 'currentstock', 'closingstock', 'availablestock'], type: ['type', 'movementtype', 'transactiontype', 'stocktype'], date: ['date', 'movementdate'], reference: ['reference', 'ref', 'remarks', 'notes'] },
};
