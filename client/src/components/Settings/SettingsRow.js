  ...
  <div className="flex items-center justify-between py-2.5">
    ...
    <div className="flex items-center gap-2">
      ...
      <input type={type} value={value} onChange={e => onChange(e.target.value)}
        ...
        className="w-48 px-3 py-1.5 text-sm border border-gray-200 dark:border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-[#1F2937] dark:text-slate-200 placeholder-gray-400 dark:placeholder-gray-500" />
    </div>
  </div>
);
