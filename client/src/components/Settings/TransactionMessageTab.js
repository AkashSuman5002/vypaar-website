        ...
        <div className="flex-1 overflow-y-auto space-y-6">
          <SettingsSection title="Message Editor">
            <div className="py-3 space-y-4">
              <div>
                <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">Transaction Type</label>
                <select value={selectedTemplate} onChange={e => setSelectedTemplate(e.target.value)}
                  className="w-full px-3 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 bg-white dark:bg-gray-800 text-[#1F2937] dark:text-gray-100">
              ...
              <div>
                <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">Message Template</label>
                <textarea value={templateText} onChange={e => setTemplateText(e.target.value)} rows={6}
                  className="w-full px-3 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 bg-white dark:bg-gray-800 text-[#1F2937] dark:text-gray-100 resize-none font-mono" />
              ...
              <div>
                <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">Available Variables</label>
                <div className="grid grid-cols-2 gap-1">
                  {templateVars.map(v => (
                    <div key={v.key} className="flex items-center gap-2 text-xs">
                      <code className="px-1 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-blue-600 font-mono">{v.key}</code>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-[#1F2937] dark:text-gray-100">Message Preview</span>
              </div>
              <span className="text-xs text-gray-400">WhatsApp Preview</span>
            </div>
            <div className="p-6 flex justify-center">
              <div className="w-[360px] bg-gray-50 dark:bg-gray-700 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div className="p-4 space-y-3">
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm">
                    <p className="text-sm text-[#1F2937] dark:text-gray-100 whitespace-pre-line">{renderPreview()}</p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-gray-100">
