  ...
  <div className="p-6 h-full flex flex-col items-center justify-center max-w-lg mx-auto text-center">
    <div className="relative mb-6">
      <div className="w-56 h-40 bg-gradient-to-br from-orange-100 via-orange-50 to-yellow-50 rounded-t-full flex items-end justify-center overflow-hidden">
        <div className="w-24 h-24 bg-white dark:bg-gray-800 rounded-t-2xl border-2 border-orange-200 flex items-center justify-center mb-0 relative">
    ...
    <div className="flex items-center justify-center gap-2 mb-2">
      <h2 className="text-2xl font-bold text-[#1F2937] dark:text-gray-100">Service Reminders</h2>
    ...
    <div className="p-6 pb-0">
      <SettingsSection title="Reminder Settings">
        <div className="flex items-center justify-between py-2.5">
          <div>
            <span className="text-sm text-[#1F2937] dark:text-gray-100">Reminder interval (days)</span>
  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
        <div className="flex items-center px-4 py-3 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-700">
          <input type="checkbox" checked={items.length > 0 && items.every(i => selected[i._id])} onChange={toggleAll}
            className="w-4 h-4 rounded border-gray-300 dark:border-gray-600 text-blue-600 focus:ring-blue-500" />
          <span className="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">ALL ITEMS</span>
        </div>
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">Number of items selected</p>
            <p className="text-2xl font-bold text-[#1F2937] dark:text-gray-100">{selectedItems.length}</p>
          </div>
        </div>
      ...
      <div>
        <h2 className="text-base font-semibold text-[#1F2937] dark:text-gray-100 mb-1">Add Reminder Details</h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Service Period<span className="text-red-500">*</span></label>
          <div className="relative">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Send Reminders to <span className="text-red-500">*</span></label>
          <select value={sendTo} onChange={e => setSendTo(e.target.value)}
            className="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none bg-white dark:bg-gray-800">
      ...
      <div className="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-lg p-5">
        <div className="flex items-start gap-3">
          <div className="w-10 h-10 bg-orange-100 rounded-xl flex items-center justify-center shrink-0">
            <Bell className="w-5 h-5 text-orange-500" />
          </div>
          <div>
            <h4 className="text-sm font-semibold text-[#1F2937] dark:text-gray-100">Get timely reminders as per service period</h4>
...
const ReminderList = ({ reminders, onRefresh }) => {
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-[#1F2937] dark:text-gray-100">Your Reminders ({reminders.length})</h3>
      </div>
          ...
          <div key={r._id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-3 hover:border-blue-300 dark:hover:border-blue-500/40 transition-colors">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-[#1F2937] dark:text-gray-100">{r.name}</p>
                  <p className="text-xs text-gray-400 flex items-center gap-3 mt-0.5">
                    ...
                    <span className="flex items-center gap-1">
                      <span className="w-4 h-4 rounded bg-gray-100 dark:bg-gray-700 flex items-center justify-center"><Check className="w-3 h-3 text-gray-500 dark:text-gray-400" /></span>
